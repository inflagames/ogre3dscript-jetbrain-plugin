...
public class MaterialMaterialProgramItemIml extends MaterialElementImp implements MaterialMaterialProgramItem {

  public MaterialMaterialProgramItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialProgramItem(this);
  }
