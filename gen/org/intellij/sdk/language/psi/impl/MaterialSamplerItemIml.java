...
public class MaterialSamplerItemIml extends MaterialElementImp implements MaterialSamplerItem {

  public MaterialSamplerItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitSamplerItem(this);
  }
