...
public class MaterialMaterialTextureNameIml extends MaterialElementImp implements MaterialMaterialTextureName {

  public MaterialMaterialTextureNameIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialTextureName(this);
  }
