...
public class MaterialMaterialPassParentIml extends MaterialElementImp implements MaterialMaterialPassParent {

  public MaterialMaterialPassParentIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialPassParent(this);
  }
