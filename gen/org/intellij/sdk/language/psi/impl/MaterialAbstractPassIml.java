...
public class MaterialAbstractPassIml extends MaterialElementImp implements MaterialAbstractPass {

  public MaterialAbstractPassIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitAbstractPass(this);
  }
