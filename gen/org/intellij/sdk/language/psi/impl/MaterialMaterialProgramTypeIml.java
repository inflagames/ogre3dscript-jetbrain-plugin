...
public class MaterialMaterialProgramTypeIml extends MaterialElementImp implements MaterialMaterialProgramType {

  public MaterialMaterialProgramTypeIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialProgramType(this);
  }
