...
public class MaterialMaterialTechniqueItemIml extends MaterialElementImp implements MaterialMaterialTechniqueItem {

  public MaterialMaterialTechniqueItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialTechniqueItem(this);
  }
  ...
  @Override
  @Nullable
  public MaterialMaterialPass getMaterialPass() {
