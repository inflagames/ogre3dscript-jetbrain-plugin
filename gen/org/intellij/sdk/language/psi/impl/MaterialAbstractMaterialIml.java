...
public class MaterialAbstractMaterialIml extends MaterialElementImp implements MaterialAbstractMaterial {

  public MaterialAbstractMaterialIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitAbstractMaterial(this);
  }
