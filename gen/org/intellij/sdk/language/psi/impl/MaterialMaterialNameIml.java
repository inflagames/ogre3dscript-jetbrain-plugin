...
public class MaterialMaterialNameIml extends MaterialElementImp implements MaterialMaterialName {

  public MaterialMaterialNameIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialName(this);
  }
