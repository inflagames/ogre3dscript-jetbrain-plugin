...
public class MaterialProgramDefaultItemIml extends MaterialElementImp implements MaterialProgramDefaultItem {

  public MaterialProgramDefaultItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitProgramDefaultItem(this);
  }
