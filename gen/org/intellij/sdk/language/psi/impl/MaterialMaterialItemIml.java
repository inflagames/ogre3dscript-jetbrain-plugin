...
public class MaterialMaterialItemIml extends MaterialElementImp implements MaterialMaterialItem {

  public MaterialMaterialItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialItem(this);
  }
  ...
  @Override
  @Nullable
  public MaterialMaterialTechnique getMaterialTechnique() {
    return findChildByClass(MaterialMaterialTechnique.class);
  }
