...
public class MaterialMaterialTextureSourceItemIml extends MaterialElementImp implements MaterialMaterialTextureSourceItem {

  public MaterialMaterialTextureSourceItemIml(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MaterialVisitor visitor) {
    visitor.visitMaterialTextureSourceItem(this);
  }
